...
export const userPasswordUpdateRequest = [
    check('oldPassword').trim().isLength({min: 6}).notEmpty().withMessage('old-Password must be at least 6 characters'),
    check('newPassword').trim().isLength({min: 6}).notEmpty().withMessage('old-Password must be at least 6 characters')
]
